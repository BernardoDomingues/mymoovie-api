...
CREATE TABLE public.mensagem (
  ...
  codigo_usuario_destinatario INT,
  FOREIGN KEY (codigo_usuario_remetente) REFERENCES usuario(id),
  FOREIGN KEY (codigo_usuario_destinatario) REFERENCES usuario(id)
);