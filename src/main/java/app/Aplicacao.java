...
public class Aplicacao {
  ...
  private static MensagemService mensagemService = new MensagemService();
  ...
  public static void main(String[] args) {
    ...
    post(
        "/mensagem",
        (request, response) -> mensagemService.enviar(request, response)
      );
    get(
        "/mensagem/:remetenteId",
        (request, response) -> mensagemService.listarMensagensPorUsuario(request, response)
      );
